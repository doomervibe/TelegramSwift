...
//        string += "accentList = \(self.accentList.map{$0.hexString}.joined(separator: ","))\n"
    ...
    public func withUpdatedBorder(_ newBorder: NSColor) -> ColorPalette {
        return ColorPalette(isNative: self.isNative, isDark: isDark,
                            tinted: tinted,
                            name: name,
                            parent: parent,
...
public let whitePalette = ColorPalette(isNative: true, isDark: false,
                                       ...
                                       bubbleBackground_outgoing: [NSColor(0x4c91c7)],
                                        ...
                                        listBackground: NSColor(0xffffff),
...
/// Focus fork: near-OLED black chrome (lists, settings, chat background). Message surfaces use slight lift for readability.
public let focusTrueBlackPalette = ColorPalette(isNative: true, isDark: true,
                                      tinted: false,
                                      name: "focusTrueBlack",
                                      parent: .dark,
                                      wallpaper: .none,
                                      ...
                                      accentList: [PaletteAccentColor(NSColor(0x2ea6ff)),
                                                   ...
                                                   PaletteAccentColor(NSColor(0xff5da2))],
                                      basicAccent: NSColor(0x2ea6ff),
                                      background: NSColor(0x000000),
                                      text: NSColor(0xf2f2f7),
                                      grayText: NSColor(0x98989d),
                                      link: NSColor(0x5ac8fa),
                                      accent: NSColor(0x2ea6ff),
                                      redUI: NSColor(0xec6657),
                                      greenUI: NSColor(0x49ad51),
                                      blackTransparent: NSColor(0x000000, 0.65),
                                      grayTransparent: NSColor(0x3a3a3c, 0.45),
                                      grayUI: NSColor(0x000000),
                                      darkGrayText: NSColor(0xaeaeb2),
                                      accentSelect: NSColor(0x2c2c2e),
                                      selectText: NSColor(0xe5e5ea),
                                      border: NSColor(0x000000),
                                      grayBackground: NSColor(0x000000),
                                      grayForeground: NSColor(0x1c1c1e),
                                      grayIcon: NSColor(0x8e8e93),
                                      accentIcon: NSColor(0x2ea6ff),
                                      badgeMuted: NSColor(0x8e8e93),
                                      badge: NSColor(0x2ea6ff),
                                      indicatorColor: NSColor(0xffffff),
                                      selectMessage: NSColor(0x1c1c1e),
                                      monospacedPre: NSColor(0xf2f2f7),
                                      monospacedCode: NSColor(0xff453a),
                                      monospacedPreBubble_incoming: NSColor(0xf2f2f7),
                                      monospacedPreBubble_outgoing: NSColor(0xf2f2f7),
                                      monospacedCodeBubble_incoming: NSColor(0xff453a),
                                      monospacedCodeBubble_outgoing: NSColor(0xf2f2f7),
                                      selectTextBubble_incoming: NSColor(0x98989d),
                                      selectTextBubble_outgoing: NSColor(0x98989d),
                                      bubbleBackground_incoming: NSColor(0x1c1c1e),
                                      bubbleBackground_outgoing: [NSColor(0x2f6fad)],
                                      bubbleBorder_incoming: NSColor(0x3a3a3c),
                                      bubbleBorder_outgoing: NSColor(0x3a9eff),
                                      grayTextBubble_incoming: NSColor(0x98989d),
                                      grayTextBubble_outgoing: NSColor(0xd1d1d6),
                                      grayIconBubble_incoming: NSColor(0x98989d),
                                      grayIconBubble_outgoing: NSColor(0xd1d1d6),
                                      accentIconBubble_incoming: NSColor(0x98989d),
                                      accentIconBubble_outgoing: NSColor(0xd1d1d6),
                                      linkBubble_incoming: NSColor(0x5ac8fa),
                                      linkBubble_outgoing: NSColor(0xffffff),
                                      textBubble_incoming: NSColor(0xf2f2f7),
                                      textBubble_outgoing: NSColor(0xffffff),
                                      selectMessageBubble: NSColor(0x1c1c1e),
                                      fileActivityBackground: NSColor(0x2ea6ff),
                                      fileActivityForeground: NSColor(0xffffff),
                                      fileActivityBackgroundBubble_incoming: NSColor(0x2ea6ff),
                                      fileActivityBackgroundBubble_outgoing: NSColor(0xffffff),
                                      fileActivityForegroundBubble_incoming: NSColor(0xffffff),
                                      fileActivityForegroundBubble_outgoing: NSColor(0x2f6fad),
                                      waveformBackground: NSColor(0x8e8e93, 0.65),
                                      waveformForeground: NSColor(0x2ea6ff),
                                      waveformBackgroundBubble_incoming: NSColor(0x8e8e93),
                                      waveformBackgroundBubble_outgoing: NSColor(0xd1d1d6),
                                      waveformForegroundBubble_incoming: NSColor(0x2ea6ff),
                                      waveformForegroundBubble_outgoing: NSColor(0xffffff),
                                      webPreviewActivity: NSColor(0x5ac8fa),
                                      webPreviewActivityBubble_incoming: NSColor(0x5ac8fa),
                                      webPreviewActivityBubble_outgoing: NSColor(0xffffff),
                                      redBubble_incoming: NSColor(0xff453a),
                                      redBubble_outgoing: NSColor(0xff453a),
                                      greenBubble_incoming: NSColor(0x32d74b),
                                      greenBubble_outgoing: NSColor(0x32d74b),
                                      chatReplyTitle: NSColor(0x5ac8fa),
                                      chatReplyTextEnabled: NSColor(0xf2f2f7),
                                      chatReplyTextDisabled: NSColor(0x98989d),
                                      chatReplyTitleBubble_incoming: NSColor(0xffffff),
                                      chatReplyTitleBubble_outgoing: NSColor(0xffffff),
                                      chatReplyTextEnabledBubble_incoming: NSColor(0xffffff),
                                      chatReplyTextEnabledBubble_outgoing: NSColor(0xffffff),
                                      chatReplyTextDisabledBubble_incoming: NSColor(0x98989d),
                                      chatReplyTextDisabledBubble_outgoing: NSColor(0xd1d1d6),
                                      groupPeerNameRed: NSColor(0xfc5c51),
                                      groupPeerNameOrange: NSColor(0xfa790f),
                                      groupPeerNameViolet: NSColor(0x895dd5),
                                      groupPeerNameGreen: NSColor(0x0fb297),
                                      ...
                                      peerAvatarPinkTop: NSColor(0xe0a2f3),
                                      peerAvatarPinkBottom: NSColor(0xd669ed),
                                      bubbleBackgroundHighlight_incoming: NSColor(0x2c2c2e),
                                      bubbleBackgroundHighlight_outgoing: NSColor(0x3d6a97),
                                      chatDateActive: NSColor(0x000000),
                                      chatDateText: NSColor(0x98989d),
                                      revealAction_neutral1_background: NSColor(0x48484a),
                                      revealAction_neutral1_foreground: NSColor(0xffffff),
                                      revealAction_neutral2_background: NSColor(0xcd7800),
                                      revealAction_neutral2_foreground: NSColor(0xffffff),
                                      revealAction_destructive_background: NSColor(0xc70c0c),
                                      ...
                                      revealAction_constructive_background: NSColor(0x08a723),
                                      revealAction_constructive_foreground: NSColor(0xffffff),
                                      revealAction_accent_background: NSColor(0x48484a),
                                      revealAction_accent_foreground: NSColor(0xffffff),
                                      revealAction_warning_background: NSColor(0xcd7800),
                                      revealAction_warning_foreground: NSColor(0xffffff),
                                      revealAction_inactive_background: NSColor(0x48484a),
                                      revealAction_inactive_foreground: NSColor(0xffffff),
                                      chatBackground: NSColor(0x000000),
                                      listBackground: NSColor(0x000000),
                                      listGrayText: NSColor(0x98989d),
                                      grayHighlight: NSColor(0x1c1c1e),
                                      focusAnimationColor: NSColor(0x5ac8fa),
                                      premium: NSColor(0x6B93FF0),
                                      vibrant: NSColor(0x808080, 0.12))
